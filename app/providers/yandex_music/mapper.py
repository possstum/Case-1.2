...
def map_artist(payload: YandexMusicArtistPayload) -> ProviderArtist:
...
def map_release(payload: YandexMusicReleasePayload) -> ProviderRelease:
...
def map_track(payload: YandexMusicTrackPayload) -> ProviderTrack:
    artist_names = list(payload.artists)
